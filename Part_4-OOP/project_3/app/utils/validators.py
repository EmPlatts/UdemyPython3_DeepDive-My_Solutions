...
def validate_integer(
    ...
    Args:
        ...
        min_value (int, optional): Specifies the minimum value (inclusive). Defaults
            to None.
        max_value (int, optional): Specifies the maximum value (inclusive). Defaults
            to None.
        custom_min_message (str, optional): Custom message when value less than
            minimum. Defaults to None.
        custom_max_message (str, optional): Custom message when value greater than
